...
// This list contains the items listed in the eighth section.
...
registerItem({
	...
	"sell":390,
	"buy":7800,
	"flavourtext":"A musical score that powers up allied monsters' defense until the end of the day.",
...
registerItem({
	...
	"sell":400,
	"buy":8e3,
	"flavourtext":"A musical score that powers up allied monsters' strength until the end of the day.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"sell":190,
	"buy":3800,
	"flavourtext":"A musical score that inspires allied monsters to do their best in combat.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	"name":"Rapid Move",
	"category":"Rune Ability",
	"sell":490,
	"buy":9800,
	"weapon":"Fist",
	"flavourtext":"Move toward an enemy in an instant. Also useful to dodge attacks.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":12e3,
	"weapon":"Fist",
	"flavourtext":"Blow away enemies by spinning your body super fast.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})

registerItem({ // unconfirmed
	"name":"Rush Punch",
	"category":"Rune Ability",
	"sell":240,
	"buy":5800,
...
registerItem({
	...
	"buy":6500,
	"weapon":"Open Hand",
	"flavourtext":"A legendary technique using palm of the hand to cause distress and surprise all in one!",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":9e3,
	"weapon":"Fist",
	"flavourtext":"Concentrate and give foes a strong blow.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":7800,
	"weapon":"Fist",
	"flavourtext":"Spin and kick enemies so hard.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":3e3,
	"weapon":"Fist",
	"flavourtext":"Launch enemies into the air.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":1900,
	"weapon":"Axe/Hammer",
	"flavourtext":"Knock enemies into the air. They can also be attacked while spinning.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":3200,
	"weapon":"Spear",
	"flavourtext":"Spinning and boring. Must face the enemy head-on to inflict continuous damage.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":8800,
	"weapon":"Spear",
	"flavourtext":"A swift stab. Creates shock waves to hit multiple times.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":2700,
	"weapon":"Spear",
	"flavourtext":"Long-ranged attack. Best used when surrounded.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":2100,
	"weapon":"Spear",
	"flavourtext":"A fancy attack with a toss, spin and juggle.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":1500,
	"weapon":"Long Sword",
	"flavourtext":"A fluid attack of lunging and cutting.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":3800,
	"weapon":"Long Sword",
	"flavourtext":"Become strong enough not to stagger when attacked, but take more damage.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":5500,
	"weapon":"Long Sword",
	"flavourtext":"Anticipate your enemy's attacks and quickly strike back.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":9800,
	"weapon":"Long Sword",
	"flavourtext":"Blow away foes with one swing. Covers wide areas very effectively.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":3400,
	"weapon":"Long Sword",
	"flavourtext":"A vertical jump-spin attack. Keep pressing the button to increase the number of spins.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":8400,
	"weapon":"Dual Blades",
	"flavourtext":"Speed up attack rate by sharpening concentration.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":2600,
	"weapon":"Dual Blades",
	"flavourtext":"Jump up and soar in the air. Also useful for dodging attacks.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":6900,
	"weapon":"Short Sword",
	"flavourtext":"A cyclone attack that blows away foes. Great to use when surrounded.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":3800,
	"weapon":"Short Sword",
	"flavourtext":"Press the button repeatedly for additional attacks and a finisher.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":2e3,
	"weapon":"Short Sword",
	"flavourtext":"Close the gap between enemies in an instant. Good timing may net you an additional leg drop.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
...
registerItem({
	...
	"buy":1300,
	"weapon":"Short Sword",
	"flavourtext":"Charge power to release shock waves.",
	"pricemultiplier":"X" /// unknown
	// cannot be used as material
})
